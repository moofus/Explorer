...
extension LocationManager {
  enum Error: LocalizedError {
    ...
    var failureReason: String? {
      switch self {
      case .authorizationDenied:
        "User denied location permissions for Explorer or location services are turned off or device is in Airplane mode"
      case .authorizationDeniedGlobally: "Location Services are disabled for this device."
      case .authorizationRestricted: "Explorer can't access your location. Do you have Parental Controls enabled?"
    ...
    var recoverySuggestion: String? {
      switch self {
      case .authorizationDenied: "Please authorize Explorer to access Location Services"
